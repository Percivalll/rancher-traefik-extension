...
<required_reading>
@/workspace/.cursor/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/workspace/.cursor/get-shit-done/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspace/.cursor/get-shit-done
                  → writes to /workspace/.cursor/get-shit-done/hooks/
...
@/workspace/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspace/.cursor/get-shit-done/references/common-bug-patterns.md
