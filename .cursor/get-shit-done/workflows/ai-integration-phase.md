...
<required_reading>
@/workspace/.cursor/get-shit-done/references/ai-frameworks.md
@/workspace/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp "/workspace/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
