...
Key references:
- @/workspace/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @/workspace/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspace/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspace/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/workspace/.cursor/get-shit-done/USER-PROFILE.md" "/workspace/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspace/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/workspace/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @/workspace/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /workspace/.cursor/get-shit-done/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspace/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Your profile:    /workspace/.cursor/get-shit-done/USER-PROFILE.md
```
