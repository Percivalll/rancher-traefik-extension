...
```bash
INIT=$(node "/workspace/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/workspace/.cursor/get-shit-done/templates/spec.md.
